...
require_once("../crud/CopiasvideojuegosCRUD.php");
require_once("../clases/CopiaVideojuego.php");
    ...
    <body>
        <header>
            <div class="container">
                ...
                <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="inventario.php" class="nav-link px-2 link-secondary">Inventario</a></li>
        ...
        <div class="container my-5">
            ...
            <form method="post" class="mb-4">
                ...
                <input type="number" name="precioNuevo" placeholder="Precio Nuevo" step="0.01" class="form-control mb-2" required>
                <input type="number" name="precioSeminuevo" placeholder="Precio Seminuevo" step="0.01" class="form-control mb-2" required>
                <input type="number" name="precioCompraGame" placeholder="Precio de Compra Game" step="0.01" class="form-control mb-2" required>
                <input type="number" name="unidades" placeholder="Unidades" class="form-control mb-2" required>
            ...
            <h2>Eliminar Copia</h2>
            <form method="post" class="mb-4">
                <select name="copiaVideojuegoId" class="form-select mb-2" required>
                    <option value="">Seleccione una Copia</option>
                    <?php 
                    if ($copiasVideojuegos && mysqli_num_rows($copiasVideojuegos) > 0):
                        while ($row = $copiasVideojuegos->fetch_assoc()): ?>
                            <option value="<?= $row['CopiaVideojuegoId'] ?>"><?= "Videojuego: " . htmlspecialchars($row['Titulo']) . " Precio Nuevo: " . htmlspecialchars($row['PrecioNuevo']) . " Unidades: " . htmlspecialchars($row['Unidades']) ?></option>
                        <?php endwhile;
                    else: ?>
                        <option value="">No hay copias de videojuegos disponibles</option>
                    <?php endif; ?>
                </select>
